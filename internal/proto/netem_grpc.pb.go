...
const (
	...
	Netem_NodeAdd_FullMethodName               = "/netem.Netem/NodeAdd"
	Netem_NodeDel_FullMethodName               = "/netem.Netem/NodeDel"
...
type NetemClient interface {
	...
	NodeAdd(ctx context.Context, in *NodeAddRequest, opts ...grpc.CallOption) (*AckResponse, error)
	...
	NodeDel(ctx context.Context, in *NodeDelRequest, opts ...grpc.CallOption) (*AckResponse, error)
...
func (c *netemClient) NodeAdd(ctx context.Context, in *NodeAddRequest, opts ...grpc.CallOption) (*AckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AckResponse)
	err := c.cc.Invoke(ctx, Netem_NodeAdd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *netemClient) NodeDel(ctx context.Context, in *NodeDelRequest, opts ...grpc.CallOption) (*AckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AckResponse)
	err := c.cc.Invoke(ctx, Netem_NodeDel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetemServer interface {
	...
	// If the topology is running and config.launch is true, the node is started.
	// If sync is true, the network file is updated to reflect the change.
	NodeAdd(context.Context, *NodeAddRequest) (*AckResponse, error)
	// NodeDel removes a node from the project topology.
	// All links and bridge connections attached to the node are removed,
	// the node container/switch is stopped and deleted, and if sync is true
	// the network file is updated.
	NodeDel(context.Context, *NodeDelRequest) (*AckResponse, error)
...
func (UnimplementedNetemServer) NodeAdd(context.Context, *NodeAddRequest) (*AckResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NodeAdd not implemented")
}
func (UnimplementedNetemServer) NodeDel(context.Context, *NodeDelRequest) (*AckResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NodeDel not implemented")
}
...
func _Netem_NodeAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetemServer).NodeAdd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Netem_NodeAdd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetemServer).NodeAdd(ctx, req.(*NodeAddRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Netem_NodeDel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NodeDelRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NetemServer).NodeDel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Netem_NodeDel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetemServer).NodeDel(ctx, req.(*NodeDelRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Netem_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NodeAdd",
			Handler:    _Netem_NodeAdd_Handler,
		},
		{
			MethodName: "NodeDel",
			Handler:    _Netem_NodeDel_Handler,
		},
		{
